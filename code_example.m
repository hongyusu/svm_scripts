function predictions = run_code_example(gammas,trainx,trainy,testx,testy,task_indexes,task_indexes_test,cv_size,Dini,iterations,...
    method_str, epsilon_init, fname)
...
predictions = test_error_unbalanced(theW,testx,testy,task_indexes_test);
